...
function testWhisper(filePath) {
    return __awaiter(this, void 0, void 0, function () {
        var openai, start, transcription, duration, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    console.log("\uD83C\uDFA7 Testing Whisper API with file: ".concat(filePath));
                ...
                case 2:
                    ...
                    console.log("---------------------------------------------------");
                    console.log("\u23F1\uFE0F Latency: ".concat(duration, "ms"));
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
                    console.error("❌ Whisper API Failed:", error_1);
                    return [3 /*break*/, 4];
